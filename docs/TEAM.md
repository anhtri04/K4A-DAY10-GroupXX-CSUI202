...
- **Tên Repository Nộp Bài:** `K4A-DAY10-GroupXX-CSUI202`
...
|---:|---|---|---|---|---|
| 1 | Phạm Minh Cương | 2A202602825 | — | Trưởng nhóm / Pipeline Integrator (`core/`, `phase1.py`, `corruption_flow.py`) | `report/2A202602825_PhamMinhCuong.md` |
